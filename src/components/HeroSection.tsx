        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/2 flex flex-col">
            ...
            <div className="flex-grow">
              ...
              <button onClick={handleCheckout} disabled={isLoading} className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 px-4 rounded-lg shadow-lg transition-all transform hover:scale-105 relative text-lg flex items-center justify-center gap-2">
                {isLoading ? (
